...
ActiveRecord::Schema.define(version: 2019_08_15_050354) do
  ...
  create_table "pull_requests_users", id: false, force: :cascade do |t|
    t.bigint "pull_request_id", null: false
    t.bigint "user_id", null: false
    t.index ["pull_request_id", "user_id"], name: "index_pull_requests_users_on_pull_request_id_and_user_id"
    t.index ["user_id", "pull_request_id"], name: "index_pull_requests_users_on_user_id_and_pull_request_id"
  end
